        ...
        <nav class="fixed bottom-0 left-0 right-0 z-50 flex justify-center pb-6 px-4 pointer-events-none">
            <div class="w-full max-w-md bg-white/80 backdrop-blur-xl border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.15)] rounded-[32px] pointer-events-auto overflow-hidden">
                <div class="flex justify-around items-center h-20 px-2">
                    <a href="{{ route('dashboard') }}" class="flex flex-col items-center flex-1 {{ request()->routeIs('dashboard') ? 'text-emerald-600' : 'text-slate-400' }}">
                    ...
                    <a href="{{ route('trips.my-trips') }}" class="flex flex-col items-center flex-1 text-slate-400">
                    ...
                    <div class="flex-1 flex justify-center -mt-10">
                        <a href="{{ route('trips.create') }}" class="w-16 h-16 bg-emerald-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-emerald-200 border-4 border-white transform hover:scale-110 transition">
                    ...
                    <a href="{{ route('profile.edit') }}" class="flex flex-col items-center flex-1 text-slate-400">
